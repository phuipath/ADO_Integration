...
namespace UiPathAutopilotPreview
{
    public partial class CodedWorkflow : CodedWorkflowBase
    {
        private Lazy<global::UiPathAutopilotPreview.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::UiPathAutopilotPreview.WorkflowRunnerService>(() => new global::UiPathAutopilotPreview.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::UiPathAutopilotPreview.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
